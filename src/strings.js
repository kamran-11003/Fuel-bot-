...
const STRINGS = {
  en: {
    ...
    CNIC_INVALID:
      `Invalid CNIC. Please enter exactly *13 digits* without dashes.\n\nExample: 3520212345678`,
    ...
    LANDMARK_REQUIRED:
      `Nearest landmark is required. Please enter the nearest landmark to the pump.`,
    ...
    DETAILS_TOO_SHORT:
      `Please write more detail (at least 10 characters).`,

    IMAGE_PROMPT:
      `Upload an image as evidence.\n\nPlease send a photo of the pump, receipt, or issue.`,

    IMAGE_REQUIRED:
      `Image is required to file a complaint. Please send a photo.`,
...
Type *Hi* to continue.`,
    ...
    STATUS_PHONE_INVALID:
      `Invalid phone number. Please enter 10–12 digits.\n\nExample: 923001234567`,

    STATUS_CNIC_PROMPT:
      `Enter your *CNIC number* to check your complaint status.\n\nExample: 3520212345678\n\nYour WhatsApp number will be used for the lookup.`,
    ...
    IMAGE_DOWNLOAD_FAILED:
      `We could not process your image. Please send the photo again.`,
  ...
  ur: {
    ...
    LANDMARK_REQUIRED:
      `قریبی نشان ضروری ہے۔ براہ کرم پمپ کے قریب ترین نشان درج کریں۔`,
    ...
    DETAILS_TOO_SHORT:
      `تھوڑی اور تفصیل درج کریں (کم از کم ۱۰ حروف)۔`,

    IMAGE_PROMPT:
      `ثبوت کے طور پر تصویر اپلوڈ کریں۔\n\nبراہ کرم پمپ، رسید، یا مسئلے کی تصویر بھیجیں۔`,

    IMAGE_REQUIRED:
      `شکایت درج کرنے کے لیے تصویر ضروری ہے۔ براہ کرم تصویر بھیجیں۔`,
...
جاری رکھنے کے لیے *Hi* لکھیں۔`,
    ...
    ERROR:
      `کچھ غلط ہوا۔ براہ کرم دوبارہ کوشش کریں۔\n\nدوبارہ شروع کرنے کے لیے *Hi* لکھیں۔`,
    ...
    STATUS_PHONE_INVALID:
      `فون نمبر غلط ہے۔ براہ کرم ۱۰ سے ۱۲ ہندسے درج کریں۔\n\nمثال: 923001234567`,

    STATUS_CNIC_PROMPT:
      `شکایت کی حیثیت چیک کرنے کے لیے اپنا *شناختی کارڈ نمبر* درج کریں۔\n\nمثال: 3520212345678\n\nآپ کا واٹس ایپ نمبر تلاش کے لیے استعمال ہوگا۔`,
    ...
    STATUS_ERROR:
      `ابھی حیثیت چیک نہیں ہو سکتی۔ براہ کرم بعد میں کوشش کریں۔\n\nدوبارہ شروع کے لیے *Hi* لکھیں۔`,

    IMAGE_DOWNLOAD_FAILED:
      `آپ کی تصویر پراسیس نہیں ہو سکی۔ براہ کرم دوبارہ تصویر بھیجیں۔`,
